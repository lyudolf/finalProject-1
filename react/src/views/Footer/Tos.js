...
<h2>이용약관</h2>
    <hr></hr>
   <h4>제 1 조 목적</h4>
    <li>본 약관은 주식회사 초대(이하 “회사”)가 운영하는 대표사이트(www.chodae.com) 에서 제공되는 인터넷 관련 서비스(이하 “서비스”) 이용과 관련하여 회사와 이용자의 권리/의무 및 책임사항을 규정함을 목적으로 합니다.</li>
    ...
    <h4>제 2 조 정의</h4> 
       ...
       <li>4. 본 약관에서 사용하는 용어의 정의는 본 조에서 정하는 것을 제외하고는 관계법령 및 서비스별 안내에서 정하는 바에 따릅니다.</li>
        ...
        <li>3. 회사는 언제든지 자신의 독자적인 판단에 따라 사전 경고 또는 통지 없이 다음과 같은 조치를 할 수 있습니다.</li>
        ...
        <h4>제 5 조 광고</h4>
        <li>이용자는 회사가 서비스의 일부로 이용자에게 프로모션 목적의 광고, 프로모션 자료 또는 기타 콘텐츠 및 자료나 제품을 배치하거나 제시한다는 데 동의합니다.</li>
